      ...
      <Popover modal={modalPopover} onOpenChange={setIsPopoverOpen} open={isPopoverOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            {...props}
            className={cn(
              'flex w-full p-1 rounded-md border items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto !shadow-none',
              className,
            )}
            ...
            {selectedValues.length > 0 ? (
                    ...
                    return (
                      <Badge
                        className={cn(
                          ...
                          'text-[#262626] font-normal text-sm',
                        )}
                        key={value}
              ...
              <div className='flex items-center justify-between w-full mx-auto'>
                <span className='text-sm text-[#676773] font-normal mx-3'>{placeholder}</span>
